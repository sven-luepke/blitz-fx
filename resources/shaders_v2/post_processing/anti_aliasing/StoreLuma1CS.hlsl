...
void CSMain(uint3 thread_id : SV_DispatchThreadID)
{
    ...
    float exposure_0 = GetExposure(avg_luma, cb3_v9.y, cb3_v9.z, cb3_v17.x, cb3_v17.z);
    float exposure_1 = GetExposure(avg_luma, cb3_v4.y, cb3_v4.z, cb3_v16.x, cb3_v16.z);

    float exposure = lerp(exposure_1, exposure_0, cb3_v13.x);
