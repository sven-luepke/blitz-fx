    ...
    out float2 motion_vector : SV_Target3)
{
    ...
    {
        {0, 0.400000, 0, 0},
        {0.125000, 0.250000, 0, 0},
        {0.250000, 0.150000, 0, 0},
        {0.375000, 0.075000, 0, 0},
        {0.500000, 0.050000, 0, 0},
        {0.625000, 0.025000, 0, 0},
        {0.750000, 0.001540, 0, 0},
        {0.980000, 0, 0, 0}
    };
    ...
    r18.xy = float2(0.333000004, 0.333000004) * v2.xy;
    r18.z = r15.y;
    r19.xyz = t0.SampleGrad(s0_s, r18.xyz, r14.xy, r14.zw).xyz;
    r19.xyz = r19.xyz * r4.zzz;
    r17.xyz = r0.www * r17.xyz + r19.xyz;
    r18.xyzw = t1.SampleGrad(s0_s, r18.xyz, r14.xy, r14.zw).xyzw;
    r18.xyzw = r18.xyzw * r4.zzzz;
    r16.xyzw = r0.wwww * r16.xyzw + r18.xyzw;
    r18.xyzw = cb6[r5.y + 1].xyzw * r4.zzzz;
    r2.w = cb6[r5.y + 0].x * r4.z;
    r18.xyzw = r0.wwww * cb6[r5.x + 1].xyzw + r18.xyzw;
    r2.w = r0.w * cb6[r5.x + 0].x + r2.w;
    r3.w = icb[r8.y + 0].x * r4.z;
    r3.w = r0.w * icb[r8.x + 0].x + r3.w;
    ...
    r18.xyzw = r4.wwww * cb6[r5.z + 1].xyzw + r18.xyzw;
    r2.w = r4.w * cb6[r5.z + 0].x + r2.w;
    r3.w = r4.w * icb[r8.z + 0].x + r3.w;
    r15.xy = float2(0.333000004, 0.333000004) * v2.xy;
    ...
    r15.xyzw = r1.wwww * cb6[r5.w + 1].xyzw + r18.xyzw;
    r2.w = r1.w * cb6[r5.w + 0].x + r2.w;
    r3.w = r1.w * icb[r8.w + 0].x + r3.w;
    ...
    r17.xyzw = cb6[r7.y + 1].xyzw * r4.zzzz;
    r4.yz = cb6[r7.y + 0].yz * r4.zz;
    r17.xyzw = r0.wwww * cb6[r7.x + 1].xyzw + r17.xyzw;
    r4.yz = r0.ww * cb6[r7.x + 0].yz + r4.yz;
    r14.xyz = icb[r6.z + 0].yyy * r11.xyx;
    ...
    {
        r26.z = r23.z;
        r6.xyz = t0.SampleGrad(s0_s, r26.xyz, r14.zy, r18.zy).xyz;
    ...
    {
        r26.w = r23.z;
        r18.xyzw = t1.SampleGrad(s0_s, r26.xyw, r14.xy, r18.xy).xyzw;
    }
    else
    {
        r18.xyzw = float4(0, 0, 0, 0);
    ...
    {
        r23.xy = r27.xy;
        r20.xyzw = t1.SampleGrad(s0_s, r23.xyz, r20.xy, r21.xy).xzwy;
    }
    else
    {
        r20.xyzw = float4(0, 0, 0, 0);
    ...
    {
        r23.xy = r27.zw;
        r21.xyzw = t1.SampleGrad(s0_s, r23.xyz, r22.xy, r22.zw).xzwy;
    }
    else
    {
    ...
    r0.w = 1 + -r20.w;
    r20.w = r4.x ? r0.w : r20.w;
    r21.w = 1 + -r21.w;
    r20.xyzw = r20.xwyz * r9.yyyy;
    r18.xyzw = r9.xxxx * r18.xyzw + r20.xyzw;
    r18.xyzw = r9.zzzz * r21.xwyz + r18.xyzw;
    r16.xyzw = r4.wwww * r18.xyzw + r16.xyzw;
    r17.xyzw = r4.wwww * cb6[r7.z + 1].xyzw + r17.xyzw;
    r4.yz = r4.ww * cb6[r7.z + 0].yz + r4.yz;
    r7.xyz = icb[r6.w + 0].yyy * r11.xyx;
    r11.xyz = icb[r6.w + 0].yyy * r11.zwz;
    r12.xyz = icb[r6.w + 0].yyy * r12.xyx;
    r13.xyz = icb[r6.w + 0].yyy * r13.xyx;
    r18.xyzw = icb[r6.w + 0].yyyy * r19.xyzw;
    r23.xy = icb[r6.w + 0].yy * v2.xy;
    r10.xyzw = icb[r6.w + 0].yyyy * r10.xyzw;
    if (r24.x != 0)
    {
        r23.z = r23.w;
        r14.xyz = t0.SampleGrad(s0_s, r23.xyz, r7.zy, r11.zy).xyz;
    ...
    if (r24.y != 0)
    {
        ...
        r14.xyz = r9.yyy * r19.xyz + r14.xyz;
    }
    if (r24.z != 0)
    {
        r19.xy = r10.zw;
        r19.z = r23.w;
        r19.xyz = t0.SampleGrad(s0_s, r19.xyz, r18.xy, r18.zw).xyz;
        r14.xyz = r9.zzz * r19.xyz + r14.xyz;
    }
    r6.xyz = r1.www * r14.xyz + r6.xyz;
    if (r24.x != 0)
    {
    ...
    {
        r23.xy = r10.zw;
        r10.xyzw = t1.SampleGrad(s0_s, r23.xyw, r18.xy, r18.zw).xzwy;
    }
    else
    {
    ...
    r10.xyzw = r1.wwww * cb6[r7.w + 1].xyzw + r17.xyzw;
    r4.xy = r1.ww * cb6[r7.w + 0].yz + r4.yz;
    r7.xyz = float3(-0.5, -0.5, -0.5) + r9.xyz;
    r0.w = dot(r7.xyz, r7.xyz);
    r0.w = rsqrt(r0.w);
    r7.xyz = r7.xyz * r0.www;
    r9.xyz = r7.yyy * r3.xyz;
    r7.xyw = r7.xxx * r2.xyz + r9.xyz;
    r7.xyz = r7.zzz * r1.xyz + r7.xyw;
    r3.xyz = r8.yyy * r3.xyz;
    r2.xyz = r8.xxx * r2.xyz + r3.xyz;
    r1.xyw = r8.zzz * r1.xyz + r2.xyz;
    r2.xyz = float3(0, 0, 1) + -r7.xyz;
    r2.xyz = r2.xyz * r1.zzz;
    r2.xyz = r4.xxx * r2.xyz + r7.xyz;
    r0.w = dot(r2.xyz, r2.xyz);
    r0.w = rsqrt(r0.w);
    ...
    r2.xyzw = r10.xyzw + -r15.xyzw;
    r2.xyzw = r0.wwww * r2.xyzw + r15.xyzw;
    r1.w = r9.w + -r14.w;
