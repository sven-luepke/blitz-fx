...
void PSMain(
    ...
    float3 previous_frame_position : TEXCOORD10,
    float3 current_frame_position : TEXCOORD11,
    ...
    out float2 motion_vector : SV_Target3)
{
    ...
    if (r0.x != 0)
        discard;
    r0.x = log2(v5.z);
    r0.x = m_fBranchSeamWeight * r0.x;
    r0.x = exp2(r0.x);
    r0.x = min(1, r0.x);
    r0.yzw = DiffuseMap.Sample(samStandard_s, v1.xy).xyz;
    r1.xyzw = cmp(float4(0.5, 0.5, 0.5, 1.5) < m_avEffectConfigFlags[1].yzww);
    if (r1.x != 0)
    {
        r2.xyzw = DetailDiffuseMap.Sample(samStandard_s, v2.xy).xyzw;
        r3.x = cmp(1.5 < m_avEffectConfigFlags[1].y);
        r3.y = v1.w * r2.w;
        r2.w = r3.x ? r3.y : r2.w;
        r2.xyz = r2.xyz + -r0.yzw;
        r0.yzw = r2.www * r2.xyz + r0.yzw;
    }
    r2.xyz = cmp(float3(0.5, 0.5, 1.5) < m_avEffectConfigFlags[2].yxx);
    if (r2.x != 0)
    {
        r3.xyz = DiffuseMap.Sample(samStandard_s, v5.xy).xyz;
        if (r1.x != 0)
        {
            r4.xyzw = DetailDiffuseMap.Sample(samStandard_s, v2.xy).xyzw;
            r1.x = cmp(1.5 < m_avEffectConfigFlags[1].y);
            r2.w = v1.w * r4.w;
            r1.x = r1.x ? r2.w : r4.w;
        ...
        r0.yzw = r0.xxx * r4.xyz + r3.xyz;
    }
    r1.x = cmp(0.5 < m_avEffectConfigFlags[3].w);
    r3.xyz = v7.xyz + r0.yzw;
    r0.yzw = r1.xxx ? r3.xyz : r0.yzw;
    r1.x = 1 + -m_fOneMinusAmbientContrastFactor;
    r3.xyz = cmp(float3(0.500999987, 0.521000028, 0.510999978) < r1.xxx);
    if (r3.x != 0)
    {
        r2.w = cmp(0.521000028 < r1.x);
        if (r2.w != 0)
        {
            r2.w = dot(speedTreeRandomColorLumWeightsTrees.xyz, r0.yzw);
            r4.xyzw = speedTreeRandomColorParamsTrees1.xyzw * v8.yyyy;
            r4.xyzw = v8.xxxx * speedTreeRandomColorParamsTrees0.xyzw + r4.xyzw;
            r4.xyzw = v8.zzzz * speedTreeRandomColorParamsTrees2.xyzw + r4.xyzw;
            r4.xyz = float3(1, 1, 1) + -r4.xyz;
            r4.xyz = max(float3(0, 0, 0), r4.xyz);
            r5.xyz = max(float3(0, 0, 0), r0.yzw);
            r5.xyz = log2(r5.xyz);
            r5.xyz = float3(2.20000005, 2.20000005, 2.20000005) * r5.xyz;
            r5.xyz = exp2(r5.xyz);
            r5.xyz = r5.xyz + -r2.www;
            r5.xyz = r5.xyz * r4.www + r2.www;
        ...
        {
            r1.x = cmp(0.510999978 < r1.x);
            if (r1.x != 0)
            {
                r1.x = dot(speedTreeRandomColorLumWeightsBranches.xyz, r0.yzw);
                r5.xyzw = speedTreeRandomColorParamsBranches1.xyzw * v8.yyyy;
                r5.xyzw = v8.xxxx * speedTreeRandomColorParamsBranches0.xyzw + r5.xyzw;
                r5.xyzw = v8.zzzz * speedTreeRandomColorParamsBranches2.xyzw + r5.xyzw;
                r5.xyz = float3(1, 1, 1) + -r5.xyz;
                r5.xyz = max(float3(0, 0, 0), r5.xyz);
                r6.xyz = max(float3(0, 0, 0), r0.yzw);
                r6.xyz = log2(r6.xyz);
                r6.xyz = float3(2.20000005, 2.20000005, 2.20000005) * r6.xyz;
                r6.xyz = exp2(r6.xyz);
                r6.xyz = r6.xyz + -r1.xxx;
                r6.xyz = r6.xyz * r5.www + r1.xxx;
            ...
            {
                r1.x = dot(speedTreeRandomColorLumWeightsGrass.xyz, r0.yzw);
                r5.xyzw = speedTreeRandomColorParamsGrass1.xyzw * v8.yyyy;
                r5.xyzw = v8.xxxx * speedTreeRandomColorParamsGrass0.xyzw + r5.xyzw;
                r5.xyzw = v8.zzzz * speedTreeRandomColorParamsGrass2.xyzw + r5.xyzw;
                r5.xyz = float3(1, 1, 1) + -r5.xyz;
                r5.xyz = max(float3(0, 0, 0), r5.xyz);
                r6.xyz = max(float3(0, 0, 0), r0.yzw);
                r6.xyz = log2(r6.xyz);
    ...
    else
    {
        ...
        r0.yzw = exp2(r0.yzw);
        r0.yzw = speedTreeRandomColorFallback.xyz * r0.yzw;
        r0.yzw = log2(r0.yzw);
        r0.yzw = float3(0.454545468, 0.454545468, 0.454545468) * r0.yzw;
        r4.xyz = exp2(r0.yzw);
    }
    r0.yzw = m_vDiffuseColor.xyz * r4.xyz;
    r0.yzw = m_vDirLight.m_vDiffuse.xyz * r0.yzw;
    r1.x = cmp(0.5 < m_avEffectConfigFlags[0].w);
    r2.w = -1 + v2.z;
    r2.w = saturate(speedTreeParams.x * r2.w + 1);
    r4.xyz = r2.www * r0.yzw;
    o0.xyz = r1.xxx ? r4.xyz : r0.yzw;
    r0.yz = SpecularMaskMap.Sample(samStandard_s, v1.xy).yw;
    r0.z = m_vDirLight.m_vTransmission.x * r0.z;
    r0.z = m_vTransmissionColor.y * r0.z;
    r0.w = v1.w * r0.z;
    r0.z = r2.z ? r0.w : r0.z;
    o0.w = r2.y ? r0.z : 0;
    r2.yzw = NormalMap.Sample(samStandard_s, v1.xy).xyz;
    if (r1.y != 0)
    {
        r0.z = DetailDiffuseMap.Sample(samStandard_s, v2.xy).w;
        r0.w = cmp(1.5 < m_avEffectConfigFlags[1].y);
        r1.x = v1.w * r0.z;
        r0.z = r0.w ? r1.x : r0.z;
        r4.xyz = DetailNormalMap.Sample(samStandard_s, v2.xy).xyz;
        r4.xyz = r4.xyz + -r2.yzw;
        r2.yzw = r0.zzz * r4.xyz + r2.yzw;
    }
    r2.yzw = r2.yzw * float3(2, 2, 2) + float3(-1, -1, -1);
    if (r2.x != 0)
    {
        r4.xyz = NormalMap.Sample(samStandard_s, v5.xy).xyz;
        if (r1.y != 0)
        {
            r0.z = DetailDiffuseMap.Sample(samStandard_s, v6.xy).w;
            r0.w = cmp(1.5 < m_avEffectConfigFlags[1].y);
            r1.x = v1.w * r0.z;
            r0.z = r0.w ? r1.x : r0.z;
            r5.xyz = DetailNormalMap.Sample(samStandard_s, v6.xy).xyz;
            r5.xyz = r5.xyz + -r4.xyz;
            r4.xyz = r0.zzz * r5.xyz + r4.xyz;
        }
        r4.xyz = r4.xyz * float3(2, 2, 2) + float3(-1, -1, -1);
        r5.xyz = -r4.xyz + r2.yzw;
        r2.yzw = r0.xxx * r5.xyz + r4.xyz;
    }
    r0.xzw = v4.yzx * v3.zxy;
    r0.xzw = v3.yzx * v4.zxy + -r0.xzw;
    r0.xzw = r0.xzw * r2.zzz;
    r0.xzw = v4.xyz * r2.yyy + r0.xzw;
    r0.xzw = v3.xyz * r2.www + r0.xzw;
    r1.x = dot(r0.xzw, r0.xzw);
    r1.x = rsqrt(r1.x);
    r0.xzw = r1.xxx * r0.xzw;
    o1.xyz = r0.xzw * float3(0.5, 0.5, 0.5) + float3(0.5, 0.5, 0.5);
    r0.x = m_vDirLight.m_vSpecular.x * r0.y;
